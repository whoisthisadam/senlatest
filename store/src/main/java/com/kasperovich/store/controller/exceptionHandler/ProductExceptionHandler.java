...
public class ProductExceptionHandler {
    ...
    @ExceptionHandler(value = NotPossibleToDeleteProductException.class)
    public ResponseEntity<Map<String, ErrorContainer>>exception(NotPossibleToDeleteProductException exception){
